...
class PermissionInGroup
{
    ...
    /**
     * @var \Morfeu\Bundle\EntityBundle\Entity\Permission
     *
     * @ORM\ManyToOne(targetEntity="Morfeu\Bundle\EntityBundle\Entity\Permission")
     * @ORM\JoinColumns({
     ...
     * Set permission
     *
     * @param \Morfeu\Bundle\EntityBundle\Entity\Permission $permission
     * @return PermissionInGroup
     */
    public function setPermission(\Morfeu\Bundle\EntityBundle\Entity\Permission $permission = null)
    {
     ...
     * Get permission
     *
     * @return \Morfeu\Bundle\EntityBundle\Entity\Permission 
     */
