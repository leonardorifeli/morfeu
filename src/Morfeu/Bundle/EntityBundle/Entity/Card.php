...
class Card
{
    ...
    /**
     * @var \Morfeu\Bundle\EntityBundle\Entity\CarrierUser
     *
     * @ORM\ManyToOne(targetEntity="Morfeu\Bundle\EntityBundle\Entity\CarrierUser")
     * @ORM\JoinColumns({
     ...
     * Set carrierUser
     *
     * @param \Morfeu\Bundle\EntityBundle\Entity\CarrierUser $carrierUser
     * @return Card
     */
    public function setCarrierUser(\Morfeu\Bundle\EntityBundle\Entity\CarrierUser $carrierUser = null)
    {
     ...
     * Get carrierUser
     *
     * @return \Morfeu\Bundle\EntityBundle\Entity\CarrierUser 
     */
