...
* @ORM\Entity(repositoryClass="Morfeu\Bundle\RepositoryBundle\Repository\BankUserRepository")
*/
class BankUser
{
    /**
    ...
    */
    ...
    {
        return "{$this->bank->getName()} - {$this->bankType->getName()} - {$this->accountNumber}";
    }
}
