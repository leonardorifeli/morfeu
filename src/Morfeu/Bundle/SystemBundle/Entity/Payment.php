...
class Payment
{
    ...
    /**
     * @var \Morfeu\Bundle\SystemBundle\Entity\PaymentFormUser
     *
     * @ORM\ManyToOne(targetEntity="Morfeu\Bundle\SystemBundle\Entity\PaymentFormUser")
     * @ORM\JoinColumns({
    ...
    /**
     * @var \Morfeu\Bundle\SystemBundle\Entity\PaymentTypeUser
     *
     * @ORM\ManyToOne(targetEntity="Morfeu\Bundle\SystemBundle\Entity\PaymentTypeUser")
     * @ORM\JoinColumns({
    ...
    /**
     * @var \Morfeu\Bundle\SystemBundle\Entity\User
     *
     * @ORM\ManyToOne(targetEntity="Morfeu\Bundle\SystemBundle\Entity\User")
     * @ORM\JoinColumns({
     ...
     * Set paymentFormUser
     *
     * @param \Morfeu\Bundle\SystemBundle\Entity\PaymentFormUser $paymentFormUser
     * @return Payment
     */
    public function setPaymentFormUser(\Morfeu\Bundle\SystemBundle\Entity\PaymentFormUser $paymentFormUser = null)
    {
     ...
     * Get paymentFormUser
     *
     * @return \Morfeu\Bundle\SystemBundle\Entity\PaymentFormUser 
     */
     ...
     * Set paymentTypeUser
     *
     * @param \Morfeu\Bundle\SystemBundle\Entity\PaymentTypeUser $paymentTypeUser
     * @return Payment
     */
    public function setPaymentTypeUser(\Morfeu\Bundle\SystemBundle\Entity\PaymentTypeUser $paymentTypeUser = null)
    {
     ...
     * Get paymentTypeUser
     *
     * @return \Morfeu\Bundle\SystemBundle\Entity\PaymentTypeUser 
     */
     ...
     * Set user
     *
     * @param \Morfeu\Bundle\SystemBundle\Entity\User $user
     * @return Payment
     */
    public function setUser(\Morfeu\Bundle\SystemBundle\Entity\User $user = null)
    {
        $this->user = $user;
     ...
     * Get user
     *
     * @return \Morfeu\Bundle\SystemBundle\Entity\User 
     */
