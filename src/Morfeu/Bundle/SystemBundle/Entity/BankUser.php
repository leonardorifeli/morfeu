...
class BankUser
{
    ...
    /**
     * @var \Morfeu\Bundle\SystemBundle\Entity\Bank
     *
     * @ORM\ManyToOne(targetEntity="Morfeu\Bundle\SystemBundle\Entity\Bank")
     * @ORM\JoinColumns({
     ...
     * Set bank
     *
     * @param \Morfeu\Bundle\SystemBundle\Entity\Bank $bank
     * @return BankUser
     */
    public function setBank(\Morfeu\Bundle\SystemBundle\Entity\Bank $bank = null)
    {
        $this->bank = $bank;
     ...
     * Get bank
     *
     * @return \Morfeu\Bundle\SystemBundle\Entity\Bank 
     */
