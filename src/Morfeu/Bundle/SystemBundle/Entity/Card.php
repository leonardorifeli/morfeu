...
class Card
{
    ...
    /**
     * @var \Morfeu\Bundle\SystemBundle\Entity\BankUser
     *
     * @ORM\ManyToOne(targetEntity="Morfeu\Bundle\SystemBundle\Entity\BankUser")
     * @ORM\JoinColumns({
    ...
    /**
     * @var \Morfeu\Bundle\SystemBundle\Entity\CarrierUser
     *
     * @ORM\ManyToOne(targetEntity="Morfeu\Bundle\SystemBundle\Entity\CarrierUser")
     * @ORM\JoinColumns({
     ...
     * Set bankUser
     *
     * @param \Morfeu\Bundle\SystemBundle\Entity\BankUser $bankUser
     * @return Card
     */
    public function setBankUser(\Morfeu\Bundle\SystemBundle\Entity\BankUser $bankUser = null)
    {
     ...
     * Get bankUser
     *
     * @return \Morfeu\Bundle\SystemBundle\Entity\BankUser 
     */
     ...
     * Set carrierUser
     *
     * @param \Morfeu\Bundle\SystemBundle\Entity\CarrierUser $carrierUser
     * @return Card
     */
    public function setCarrierUser(\Morfeu\Bundle\SystemBundle\Entity\CarrierUser $carrierUser = null)
    {
     ...
     * Get carrierUser
     *
     * @return \Morfeu\Bundle\SystemBundle\Entity\CarrierUser 
     */
