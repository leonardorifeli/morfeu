...
class PaymentFormUser
{
    ...
    /**
     * @var \MorfeuApi\Bundle\EntityBundle\Entity\Payment
     *
     * @ORM\ManyToOne(targetEntity="MorfeuApi\Bundle\EntityBundle\Entity\Payment")
     * @ORM\JoinColumns({
     ...
     * Set payment
     *
     * @param \MorfeuApi\Bundle\EntityBundle\Entity\Payment $payment
     * @return PaymentFormUser
     */
    public function setPayment(\MorfeuApi\Bundle\EntityBundle\Entity\Payment $payment = null)
    {
     ...
     * Get payment
     *
     * @return \MorfeuApi\Bundle\EntityBundle\Entity\Payment 
     */
     ...
     * Set card
     *
     * @param \MorfeuApi\Bundle\EntityBundle\Entity\Card $card
     * @return PaymentFormUser
     */
    public function setCard(\MorfeuApi\Bundle\EntityBundle\Entity\Card $card = null)
    {
        $this->card = $card;
